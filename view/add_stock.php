...
<?php
$page_title = "Add Stock - Soft Stock Solo Web Application";
?>
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col">
                <div class="container mt-4">
                    <h1>Add Stock</h1>
                    <form action="../includes/add_stock.inc.php" method="POST" class="needs-validation mt-5" novalidate>
                        <div class="mb-3 row">
                            <div class="col">
                            ...
                            <div class="col">
                                <label for="input-add-stock-batch-number" class="form-label">Batch Number</label>
                                <input type="text" class="form-control" id="input-add-stock-batch-number" name="input-add-stock-batch-number" placeholder="Batch Number" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label for="input-add-stock-initial-stock" class="form-label">Initial Stock</label>
                                <input type="number" class="form-control" id="input-add-stock-initial-stock" name="input-add-stock-initial-stock" placeholder="Initial Stock" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col">
                                <label for="input-add-stock-current-stock" class="form-label">Current Stock</label>
                                <input type="number" class="form-control" id="input-add-stock-current-stock" name="input-add-stock-current-stock" placeholder="Current Stock" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label for="input-add-stock-expire-date" class="form-label">Expire Date</label>
                                <input type="date" class="form-control" id="input-add-stock-expire-date" name="input-add-stock-expire-date" placeholder="Expire Date" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col">
                                <label for="input-add-stock-cost-price" class="form-label">Cost Price</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rs.</span>
                                    <input type="number" class="form-control" id="input-add-stock-cost-price" name="input-add-stock-cost-price" placeholder="Cost Price" min="0.00" max="10000.00" step="0.01" required>
                                </div>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col">
                                <label for="input-add-stock-unit-price" class="form-label">Unit Price</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Rs.</span>
                                    <input type="number" class="form-control" id="input-add-stock-unit-price" name="input-add-stock-unit-price" placeholder="Unit Price" min="0.00" max="10000.00" step="0.01" required>
                                </div>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg w-100 mt-2" name="add-stock-submit">Add Stock</button>
                    </form>
                    <?php
                    if (isset($_GET["error"])) {
                        ...
                        <div class="col-md-3">
                            ...
                            <table class="table table-hover table-secondary mt-2" id="product-table">
                                ...
                                <tbody>
                                    ...
                                    if (empty($products)) {
                                        echo '<tr><td colspan="2" class="text-center">You don\'t have any saved product to display here</td></tr>';
                                    } else {
                                ...
                                <tbody>
                                    ...
                                    if (empty($stocks)) {
                                        ...
                                        foreach ($stocks as $stockItem) {
                                            ...
                                            echo '<td>' . $stockItem['batch_number'] . '</td>';
                                            echo '<td>' . $stockItem['initial_stock'] . '</td>';
                                            echo '<td>' . $stockItem['current_stock'] . '</td>';
                                            echo '<td>' . $stockItem['expire_date'] . '</td>';
                                            echo '<td>' . $stockItem['cost_price'] . '</td>';
                                            echo '<td>' . $stockItem['unit_price'] . '</td>';
                                            echo '</tr>';
                                        }
                                    }
                                    ?>
...
<script>
    $(document).ready(function() {
        $('#search-input').on('input', function() {
            ...
            $.ajax({
                type: 'POST',
                url: '../includes/search_products.inc.php', // Create this PHP file
                data: {
                    search: searchQuery
                },
...
<script>
    ...
    //     const inputProductId = document.getElementById('input-add-stock-product-id');
    //     const inputBarcodeNumber = document.getElementById('input-add-stock-barcode-number');

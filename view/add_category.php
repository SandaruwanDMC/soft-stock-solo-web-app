    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col">
                <div class="container mt-4">
                    <h1>Add Category</h1>
                    <form action="../includes/add_category.inc.php" method="POST" class="needs-validation mt-5" novalidate>
                        <div class="mb-3 row">
                            <div class="col">
                                <label for="input-add-category-name" class="form-label">Category Name</label>
                                <input type="text" class="form-control" id="input-add-category-name" name="input-add-category-name" placeholder="Category Name" required>
                            ...
                            <div class="col">
                                <label for="input-add-category-other-info" class="form-label">Other Information</label>
                                <input type="text" class="form-control" id="input-add-category-other-info" name="input-add-category-other-info" placeholder="Other Information">
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg w-100 my-3" name="add-category-submit">Add Category</button>
                    </form>

        ...
        <div class="row flex-nowrap">
            <div class="bg-secondary col-auto min-vh-100 d-flex flex-column justify-content-between">
                <div class="bg-secondary p-2">
                    <a href="#" class="d-flex text-decoration-none mt-3 ms-3 me-3 align-item-center text-white">
                        <span class="fs-1 d-none d-sm-inline">Soft Stock Solo</span>
                    ...
                    <ul class="nav nav-pills flex-column mt-4">
                        ...
                        <li class="nav-item py-2 py-sm-0">
                            <a href="#" class="nav-link text-white">
                                <span class="material-symbols-outlined fa-m me-1 fa-fw align-middle">
                                    qr_code_scanner
                                </span><span class="fs-4 ms-3 d-none d-sm-inline align-middle">Sell Product</span>
                            </a>
                        </li>
                        <li class="nav-item py-2 py-sm-0">
                            <a href="#" class="nav-link text-white">
                        ...
                        <li class="nav-item py-2 py-sm-0">
                            <a href="#" class="nav-link text-white">
                                ...
                                </span><span class="fs-4 ms-3 d-none d-sm-inline align-middle">View Products</span>
                            </a>
                        </li>
                        <li class="nav-item py-2 py-sm-0">
                            <a href="#" class="nav-link text-white">
                        ...
                        <li class="nav-item py-2 py-sm-0">
                            <a href="#" class="nav-link text-white">
                                ...
                                <!-- <i class="fas fa-right-from-bracket fa-m me-3 fa-fw"></i></i><span class="fs-4 ms-3 d-none d-sm-inline ">Sign Out</span> -->
                            </a>
                        </li>
                        <li class="nav-item py-2 py-sm-0">
                            <a href="./includes/sign_out.inc.php" class="nav-link text-white">
                                <!-- <i class="fas fa-right-from-bracket fa-m me-3 fa-fw"></i></i></i><span class="fs-4 ms-3 d-none d-sm-inline">Sign Out</span> -->
